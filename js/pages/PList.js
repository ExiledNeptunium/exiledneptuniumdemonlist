...
import { fetchEditors, fetchPList } from "../content.js";
...
export default {
    ...
    template: `
        ...
        <main v-else class="page-plist">
            <div class="plist-container">
                <table class="plist" v-if="plist">
                    <tr v-for="([level, err], i) in plist">
                        <td class="rank">
